...
export const AnswerSchema = z.object({
  content: z.string().min(100, { message: "Answer must contain atleast 100 characters." }),
});
...
export const AIAnswerSchema = z.object({
  ...
  content: z.string().min(100, { message: "Answer must be greater than 100 characters." }),
