    ...
    return (
        <div className='mt-16 flex w-full flex-col items-center justify-center sm:mt-36'>
            <>
                ...
                <Image src={image.light} alt={image.light} width={270} height={200} className='block object-contain dark:hidden' />
            </>
            ...
            {button && (
                <Link href={button.href}>
                    <Button className="paragraph-medium mt-5 min-h-[46px] rounded-lg bg-primary-500 px-4 py-3 text-light-900 hover:bg-primary-500 hover:cursor-pointer">{button.text}</Button>
                </Link>
            )}
        </div>
    )
