...
const AuthForm = <T extends FieldValues>({
 ...
 <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="mt-10 space-y-6">
        ...
        <Button disabled={form.formState.isSubmitting} type="submit" className='primary-gradient paragraph-medium min-h-12 w-full rounded-2 px-4 py-3 font-inter !text-light-900'>{form.formState.isSubmitting ? buttonText === "Sign In" ? "Signing In..." : "Signing Up..." : buttonText}</Button>
